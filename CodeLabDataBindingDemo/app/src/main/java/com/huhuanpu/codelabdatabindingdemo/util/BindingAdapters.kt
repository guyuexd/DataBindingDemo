package com.huhuanpu.codelabdatabindingdemo.util
...
import com.huhuanpu.codelabdatabindingdemo.data.Popularity
...
private fun getDrawablePopularity(popularity: Popularity, context: Context) : Drawable? {
    return when (popularity) {
        ...
        Popularity.STAR -> {
            ContextCompat.getDrawable(context, R.drawable.ic_whatshot_green_96dp)
        }
    }
}